async function InsertSampleData(db) {
  try {
    ...
    const buildingStructres = await db.BuildingStructure.bulkCreate([
      ...
      { campus_id: campuses[0].campus_id, buildingName: "Main Building", floorName: "3rd Floor", roomName: "302", isRoom: true},
      { campus_id: campuses[0].campus_id, buildingName: "Main Building", floorName: "3rd Floor", roomName: "303", isRoom: true},
      { campus_id: campuses[0].campus_id, buildingName: "Main Building", floorName: "3rd Floor", roomName: "304", isRoom: true},
      ...
      { campus_id: campuses[0].campus_id, buildingName: "Main Building", floorName: "3rd Floor", roomName: "314", isRoom: true},
