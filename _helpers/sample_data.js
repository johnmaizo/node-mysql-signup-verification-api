async function InsertSampleData(db) {
  try {
    ...
    const semesters = await db.Semester.bulkCreate([
      { campus_id: campuses[1].campus_id, semesterName: "1st Semester", schoolYear: "2024-2025" },
      { campus_id: campuses[1].campus_id, semesterName: "2nd Semester", schoolYear: "2024-2025" },
      { campus_id: campuses[1].campus_id, semesterName: "Summer", schoolYear: "2024-2025" },
      { campus_id: campuses[0].campus_id, semesterName: "1st Semester", schoolYear: "2024-2025" },
      { campus_id: campuses[0].campus_id, semesterName: "2nd Semester", schoolYear: "2024-2025" },
      { campus_id: campuses[0].campus_id, semesterName: "Summer", schoolYear: "2024-2025" }
    ]);
    ...
    const programs = await db.Program.bulkCreate([
      ...
      {department_id: departments[0].department_id, programCode: "BSBA-HRM", programDescription: "Bachelor of Science in Business Administration major in Human Resources"},
    ...
    const courseinfos = await db.CourseInfo.bulkCreate([
      ...
      { campus_id: campuses[0].campus_id, courseCode: "IT411L", courseDescription: "Integrative Programming & Technologies - Lec", unit: 1},
